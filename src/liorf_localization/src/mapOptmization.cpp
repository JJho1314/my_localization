...
public:
    ...
    {
        tf::Quaternion q(0.00526945575735, 0.00595958923934,
                         -0.484110825845, 0.874970527751);
        tf::Matrix3x3 qm(q);
        ...
        initialize_pose[3] = -175.839205868;
        initialize_pose[4] = 65.71887691;
        initialize_pose[5] = -1.38476089371;
